...
(function() {
	...
	window.CLOSURE_UNCOMPILED_DEFINES = {
		...
		appendScript('/js/i18n/generated/compiled/chromechart/en.js');
	
		appendScript('app/webroot/js/app/view/angular/templates/compiled/common-templates.js');
	
		appendScript('/js/closure/bin/chromechart.js');
